      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-200">
        ...
        <div className="flex items-center gap-3 flex-wrap bg-white p-3 rounded-2xl border-2 border-slate-900 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)]">
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-900 text-xs font-black">
              ▼
            </div>
          </div>
            ...
            >
              ...
              <div className="md:col-span-8 space-y-4 flex flex-col justify-between h-full">
                <div className="space-y-2">
                  <div className="flex items-center gap-3">
                    <span className="px-3 py-0.5 rounded-full bg-white text-slate-900 font-black text-xs font-heading border border-slate-900 shadow-sm">
                      📅 {event.dateString}
                    </span>
                ...
                <div className="space-y-1.5 pt-1">
                  <span className="text-[11px] font-black uppercase text-slate-600 font-heading">
                    🏆 Winners &amp; Standings:
                  </span>
          ...
          <div className="bg-[#FFFDF5] rounded-3xl border-4 border-slate-900 shadow-2xl max-w-2xl w-full p-6 sm:p-8 space-y-6 max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
            <div className="flex items-start justify-between pb-4 border-b-2 border-slate-900">
              ...
              <button
                ...
                className="w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-900 font-black text-sm border-2 border-slate-900 flex items-center justify-center shrink-0"
              >
                ✕
              </button>
            </div>
