      ...
      {loading && (
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#30B2E7]/10 rounded-full blur-3xl animate-pulse" />
            <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#FDB913]/15 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="relative z-10 flex flex-col items-center justify-center min-h-[300px]">
            ...
            {(scene === 3 || scene === 4 || scene === 5) && (
              ...
              >
                ...
                {/* QT Mascot — direct SVG img with bounce */}
                <motion.div
                  animate={
                    scene === 5
                ...
                >
                  <img
                    ...
                    height="144"
                    loading="eager"
                    style={{ objectFit: 'contain', filter: 'drop-shadow(0 4px 16px rgba(0,0,0,0.15))' }}
                  />
                  {scene === 3 && (
                    <motion.span
                      ...
                      className="mt-2 px-3 py-1 text-xs font-black rounded-full border-2 border-black bg-[#FDB913] text-black"
                  ...
                  {scene === 4 && (
                    <motion.span
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 0.2 }}
                      className="mt-2 px-3 py-1 text-xs font-black rounded-full border-2 border-black bg-[#30B2E7] text-white"
                      style={{ boxShadow: '2px 2px 0px #000' }}
                    >
                      Ready to Explore!
                    </motion.span>
          ...
          <div className="mt-8 h-8 flex items-center justify-center">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                style={{ fontFamily: 'Causten Round Black, sans-serif' }}
              >
