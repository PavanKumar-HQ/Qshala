...
export default function InteractiveQuizCard({ quiz }: InteractiveQuizCardProps) {
  ...
  return (
    <div className="bg-white rounded-3xl p-5 md:p-6 shadow-md hover:shadow-xl transition-all border-2 border-black relative overflow-hidden flex flex-col justify-between h-full min-h-[460px]">
      <div>
        <div className="flex items-center justify-between mb-3 gap-2">
          <span className="px-3 py-1 rounded-full bg-[#30B2E7] text-white font-black text-[11px] uppercase tracking-wider flex items-center gap-1 border border-black shrink-0 font-heading">
            {quiz.category}
          </span>
          <span className="px-2.5 py-1 rounded-full bg-[#FDB913] text-black text-[11px] font-black border border-black shrink-0 font-heading">
            ⚡ {quiz.difficulty}
          </span>
        </div>

        <div className="min-h-[56px] flex items-center mb-4">
          <h3 className="text-lg md:text-xl font-black text-black leading-snug font-heading line-clamp-2">
            {quiz.question}
          </h3>
        </div>
      ...
      <AnimatePresence>
        {showExplanation && (
          ...
          >
            <div className="font-black text-black mb-1 uppercase tracking-wider text-[10px]">
